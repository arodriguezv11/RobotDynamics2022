...
kp = params.kp_joint; % P gain matrix for joints (3x3 diagonal matrix)
kd = params.kd_joint; % D gain matrix for joints (3x3 diagonal matrix)
...
%% Compute torque
tau = zeros(3,1); % TODO: Implement tau here
