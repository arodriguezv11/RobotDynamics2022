...
try
  ...
  q_des = q_eval / 2.0;
  dq_des = dq_eval / 2.0;
  T_IGd = eval(subs(kin.T_IG, {'q0' 'q1' 'q2'}, {q_des(1) q_des(2) q_des(3)}));
  I_r_IGd = T_IGd(1:3, 4);
  I_v_Gd = jac.I_Jp_G * dq_des;
  C_IGd = eye(3);
  
  tau = Q4_task_space_control(params, gc_eval, kin, I_r_IGd, I_v_Gd, C_IGd, 0.0);
